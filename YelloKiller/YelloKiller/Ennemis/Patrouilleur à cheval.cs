...
namespace YelloKiller
{
    class Patrouilleur_a_cheval : Ennemi
    {
        ...
        {
            base.Update(gameTime, new Rectangle((int)Index * 24, 0, 23, 30), new Rectangle((int)Index * 24, 65, 23, 30), new Rectangle((int)Index * 24, 98, 23, 30), new Rectangle((int)Index * 24, 34, 23, 30), heros1, heros2, morts, fumeeHeros1, fumeeHeros2);
